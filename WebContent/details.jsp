                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        ...
                                        <li><img src="StyleUser/assets/img/icon/header_icon1.png" alt="">Tuesday, 18th June, 2019</li>
                                    </ul>
                                </div>
                            ...
                            <div class="trending-tittle">
	                            ...
	                            <div class="trending-animated">
	                                <ul id="js-news" class="js-hidden">
	                                	<c:forEach items="${lastNewsTop}" var="objet">
                   ...
                   <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="about-right mb-90">
                                <div class="about-img">
                                    <img src='uploads/750x400/<c:out value="${article.image}"/>' alt="">
                                </div>
                                ...
                                <div class="about-prea">
                                    <p class="about-pera1 mb-25">
                                       <c:out value="${article.contenu}"/>.</p>
                                </div> 
                                <div class="social-share pt-30">
                                    <div class="section-tittle">
                                        <h3 class="mr-20">Share:</h3>
                                        <ul>
                                            <li><a href="#"><img src="StyleUser/assets/img/news/icon-ins.png" alt=""></a></li>
                                            <li><a href="#"><img src="StyleUser/assets/img/news/icon-fb.png" alt=""></a></li>
                                            <li><a href="#"><img src="StyleUser/assets/img/news/icon-tw.png" alt=""></a></li>
                                            <li><a href="#"><img src="StyleUser/assets/img/news/icon-yo.png" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
